        ...
        private void renamePageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(name))
                {
                    ...
                    ClickedNode.Editor.FindReplace($"Definition{page.Name}", $"Definition{name}");
                    ClickedNode.Editor.UpdateDocument();
                    ...
                    foreach (BookNode sub in ClickedNode.Nodes)
                    {
                        ...
                        string subcode = sub.Editor.Text.Replace($"Definition{page.Name}", $"Definition{name}");
                        ...
                        sub.Editor.FindReplace($"Definition{page.Name}", $"Definition{name}");
                        sub.Editor.UpdateDocument();
