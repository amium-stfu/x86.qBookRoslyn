...
namespace QB.Controls
{
    ...
    public class BoxLabel : UIBox
    {
        ...
        public override void Create()
        {
            Frame = new QB.Controls.Box(Name, x: X, y: Y, w: W, h: H
                , boxes: new[] {
                new QB.Controls.Box(Name, textFunction: () => Label, x:0, y:0, w:"100%", h:"100%", format: $"bg:#e6e6e6,align:ml", style:$"font::{FontSize}:,align:tl,bg-hover:Transparent")
                {
    ...
    public class BoxParameterObject : UIBox
    {
       ...
       internal Box ParameterName;
        ...
        void editTarget()
        {
            ...
            if (parameterStyle == "signal")
            {
                Signal read = Target as Signal;
                read.ShowEditDialog();
                Update();
            }
            if (parameterStyle == "bool") {
                Signal read = Target as Signal;
                read.Value = read.Value == 1 ? 0 : 1;
                Update();
            };

            if (parameterStyle == "text")
            {
            ...
            if (parameterStyle.Contains("file"))
            {
            ...
            if (parameterStyle.Contains("folder"))
            {
                string folder = modeParameter == null ? System.IO.Path.Combine(QB.Book.SettingsDirectory, "csv") : modeParameter;

                QB.Logger.Info("Select folder '" + folder + "'");
                ...
                using (System.Windows.Forms.OpenFileDialog openFileDialog = new System.Windows.Forms.OpenFileDialog())
                {
                    ...
                    if (openFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    {
                        read.Value = System.IO.Path.GetDirectoryName(openFileDialog.FileName);
                        Update();
                    }
                }
            }
        ...
        public void Update()
        {
            QB.Logger.Info("Update SettingsValue Mode: " + parameterStyle);
            ...
            if (parameterStyle.Contains("uri"))
            {
                StringSignal read = Target as StringSignal;
                ParameterName.Text = read.Text;
                ParameterRead.Text = read.Value;
        ...
        public void SetParameter(object target, BoxParameterStyle viewType)
        {
            modeParameter = null;
              Target = target;
            if (target == null)
            ...
            try
            {
                if (target is Signal)
                {
                    ...
                    if (viewType == BoxParameterStyle.Bool)
                    {
                        reset();
                        BoolView();
                        ParameterName.Text = read.Text;
                    ...
                    else if (viewType == BoxParameterStyle.Signal)
                    {
                        reset();
                        SignalView();
                        ParameterName.Text = read.Text;
                ...
                {
                    StringSignal read = Target as StringSignal;
                    if (viewType == BoxParameterStyle.Text)
                    {
                        reset();
                        StringSignalView();
                        ParameterName.Text = read.Text;
                    ...
                    if (viewType == BoxParameterStyle.Divider)
                    {
                        reset();
                        StringSignalView();
                        ParameterName.Text = read.Text;
                    ...
                    if (viewType == BoxParameterStyle.File)
                    {
                        reset();
                        StringSignalView();
                    ...
                    if (viewType == BoxParameterStyle.Folder)
                    {
                        reset();
                        StringSignalView();
                        ParameterName.Text = read.Text;
                        ParameterRead.Text = read.Value;
                        parameterStyle = "folder";
